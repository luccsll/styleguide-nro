    ...
    stepsArray.forEach((step, index) => {
        ...
        <li class="stepNro" data-id="${index + 1}" data-deadline="${step.deadline}">
            ...
            <div class="stepContent">
                <h2 class="stepContentActivity">${step.activity}a</h2>
        ...
        if (!isNaN(Number(step.responsible))) {
            ...
            console.log(isNaN(Number(step.responsible)))
            console.log(step.responsible)
            console.log(a)
            responsible = a['colleagueName']

        } else {
            console.log(step.responsible)
            responsible = step.responsible.length > 14 ? dataColleague.substring(0, 14) + '...' : dataColleague
